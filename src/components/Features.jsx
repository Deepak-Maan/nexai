                ...
                <div className="grid lg:grid-cols-2 pt-10 sm:pt-20 max-h-[650px] sm:max-h-[576px] my-scroll  overflow-y-scroll">
                    <div className='flex flex-col max-lg:items-center'>
                        <div className='max-w-[364px] group  bg-white px-6 pt-[30px] pb-11 rounded-2xl mb-5 sm:mb-10 md:mb-20 lg:mb-[175px]'>
                            <Clock />
                            <p className=' font-recharge group-hover:text-[#02CDCF] duration-300 font-bold text-xl leading-[32px] text-[#0B1010] pt-[30px]'>Remote Access and File Management</p>
                        ...
                        <div className='max-w-[364px] group duration-300 bg-white px-6 pt-[30px] pb-11 rounded-2xl'>
                            <Messages />
                            <p className=' font-recharge group-hover:text-[#02CDCF] duration-300 font-bold text-xl leading-[32px] text-[#0B1010] pt-[30px]'>Autonomous and Natural Language Communication</p>
                    ...
                    <div className='flex flex-col max-sm:mt-5 max-md:mt-20 max-lg:mt-[175px] lg:pt-[300px] items-center lg:items-end'>
                        <div className='max-w-[364px] group duration-300 bg-white px-6 pt-[30px] pb-11 rounded-2xl mb-5 sm:mb-10 md:mb-20 lg:mb-[175px]'>
                            <ClockPlus />
                            <p className=' font-recharge group-hover:text-[#02CDCF] duration-300 font-bold text-xl leading-[32px] text-[#0B1010] pt-[30px]'>Real-time Home Monitoring</p>
                        ...
                        <div className='max-w-[364px] group duration-300 bg-white px-6 pt-[30px] pb-11 rounded-2xl'>
                            <ThreeLines />
                            <p className=' font-recharge group-hover:text-[#02CDCF] duration-300 font-bold text-xl leading-[32px] text-[#0B1010] pt-[30px]'>Intelligent Contextual Awareness</p>
