...
const What = () => {
    return (
        <div className='px-3 pt-[160px]'>
            <div className="mx-auto overflow-hidden max-w-[1350px] pb-[174px] pt-[163px] ps-3 sm:ps-6 md:ps-12 lg:ps-[100px] border border-white rounded-3xl bg-[url('./assets/images/gif/What-bg.gif')] ">
